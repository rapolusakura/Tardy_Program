<?php
if(!isset($_COOKIE["school_id"]) || $_COOKIE["school_id"]!="Monte Vista High School") {
...
<body>
	...
	<button class="selectedTablink" onclick="signInMode('Monte Vista High School')" id="sign-in">SIGN-IN</button>
