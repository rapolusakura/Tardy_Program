...
<div class="row">
  ...
  <div class="column right">
		...
		<input style  = "padding: 16px" onkeyup="search()" onkeypress="getSheetID()"autofocus class = "nonprint search" type="text" id = "name" name = "name" autocomplete = "off" placeholder="ex. 123456"></input>
